...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
//        [self setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"shujia.png"]]];
        [self addSubview:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"shujia.png"]]];
