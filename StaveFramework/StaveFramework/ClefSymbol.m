...
static UIImage* treble = nil;  /** The treble clef image */
static UIImage* bass = nil;    /** The bass clef image */
...
+ (void)loadImages {
    ...
    if (treble == NULL) {
        filename = [[NSBundle mainBundle] 
                    ...
                    ofType:@"png"];
        treble = [[UIImage alloc] initWithContentsOfFile:filename];
    ...
    if (bass == NULL) {
        filename = [[NSBundle mainBundle] 
                    ...
                    ofType:@"png"];
        bass = [[UIImage alloc] initWithContentsOfFile:filename];
        //[bass setFlipped:YES];
    }
}
