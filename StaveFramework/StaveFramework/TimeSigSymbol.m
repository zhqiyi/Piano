...
static UIImage* images[13];     /** The images for each number */
...
- (id)initWithNumer:(int)numer andDenom:(int)denom andStartTime:(int)start{
    numerator = numer;
    denominator = denom;
    starttime = start;      /** add by sunlie */
...
- (int)startTime {
//    return -1;
    return starttime;         /** modify by sunlie */
}
...
//    [trans concat];
    ...
    UIImage *numer = images[numerator];
    UIImage *denom = images[denominator];
...
//           fraction:1.0];
    ...
    [numer drawInRect:CGRectMake(0, ytop, imgwidth, imgheight)];
...
//           fraction:1.0];
    ...
    [denom drawInRect:CGRectMake(0, ytop + imgheight, imgwidth, imgheight)];
