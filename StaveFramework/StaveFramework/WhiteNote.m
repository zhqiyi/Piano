...
+(WhiteNote*) topTreble {
    if (_topTreble == nil) {
        _topTreble = [WhiteNote allocWithLetter:WhiteNote_E andOctave:5];
    }
    return _topTreble;
}
...
+(WhiteNote*) bottomTreble {
 ...
 //       _bottomTreble = [WhiteNote allocWithLetter:WhiteNote_F andOctave:4];
        _bottomTreble = [WhiteNote allocWithLetter:WhiteNote_E andOctave:4];    /** modify by sunlie */
    }
...
+(WhiteNote*) topBass {
    if (_topBass == nil) {
        _topBass = [WhiteNote allocWithLetter:WhiteNote_G andOctave:3];
    }
    return _topBass;
}
...
+(WhiteNote*) bottomBass {
    if (_bottomBass == nil) {
        _bottomBass = [WhiteNote allocWithLetter:WhiteNote_A andOctave:3];
    }
    return _bottomBass;
}
...
+(WhiteNote*) middleC {
    if (_middleC == nil) {
        _middleC = [WhiteNote allocWithLetter:WhiteNote_C andOctave:4];
    }
    return _middleC;
}
